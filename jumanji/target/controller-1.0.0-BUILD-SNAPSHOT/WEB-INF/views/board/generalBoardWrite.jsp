...
//썸네일 붙이기
var pasteThumbnail = function(originalLink){
	console.log("----------------------________________--------------------");
	
	console.log(originalLink);
	//let original_length = original_Link.length; //ckImgSubmit
	//console.log("Length : "+original_length);
	//썸네일 영역 초기화
	//$("#thumbnailDiv").html("");
	//이미지 검사 해야 함
	/**/
	       ...
	       // console.log("dialogDefinition  > "+dialogDefinition )
	        if (dialogName == 'image') {
	           ...
	           dialogDefinition.onOk = function(e) {
	              ...
	              console.log("경로 > "+imageSrcUrl);
	              console.log(e);
	              console.log(e.sender);
	              //console.log(e.sender.originalElement.$);
	             // console.log(e.sender.imageEditMode.$);
	              //console.log(e.sender.linkElement.$);
	             // console.log(e.sender.linkElement.$.width);
	            //  console.log(e.sender.linkElement.$.height);
	             // 
	              var width1 = e.sender.originalElement.$.txtWidth;
	              var width2 = e.sender.originalElement.$.txtHeight;
	              console.log(width1);
	              console.log(width2);
	              ...
	              console.log("지정 width > "+width);
	              console.log("지정 height > "+height);

	              
	              //var imgHtml = CKEDITOR.dom.element.createFromHtml("<img src=" + imageSrcUrl + " alt='' style='width:"+width+"px; height:"+height+"px;'>");
	              var imgHtml = CKEDITOR.dom.element.createFromHtml("<img src=" + imageSrcUrl + " alt=''>");
	              
	              editor.insertElement(imgHtml);
	          	  //pasteThumbnail(imageSrcUrl);	
	              //http://localhost:8000/board/mine/ckImgSubmit?uid=70f9e70f-f44c-45fe-b514-811402499fe6&fileName=09.png
	           };
	        }
	  });
	*/
