    ...
    <body>
        ...
        <div id="main">
            ...
            <header class="main-header">
                <!-- logo-->
                <a href="index.html" class="logo-holder"><img src="/resources/images/logo.png" alt=""></a>
                <!-- logo end-->
                <!-- header-search_btn-->         
                ...
                <div class="show-reg-form modal-open avatar-img" data-srcav="/resources/images/avatar/3.jpg"><i class="fal fa-user"></i>Sign In</div>
                <!-- header opt end--> 
                <!-- lang-wrap-->
                <div class="lang-wrap">
